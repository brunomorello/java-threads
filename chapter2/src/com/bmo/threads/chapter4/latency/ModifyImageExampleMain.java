package com.bmo.threads.chapter4.latency;
...
public class ModifyImageExampleMain {

    public static final String SOURCE_IMG = "./resources/chapter4/many-flowers.jpg";
    public static final String DESTINATION_IMG = "./resources/chapter4/out/test.jpg";
...
//        recolorSingleThreaded(originalImage, resultImage);
        ...
        File file = new File(DESTINATION_IMG);
        ImageIO.write(resultImage, "jpg", file);

        System.out.println("Single Thread execution time: " + execTime);
    }
